              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="h-10 px-3 rounded-full text-xs font-semibold bg-slate-900 text-white"
                  >
                    Apply
                  </button>
                  {appliedPromoCode ? (
                    <button
                      ...
                      className="h-10 px-3 rounded-full text-xs font-semibold bg-slate-100 text-slate-700"
                    >
                      Clear
                    </button>
                  ) : null}
