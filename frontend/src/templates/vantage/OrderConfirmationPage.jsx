  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(160deg,_#fdfbf6_0%,_#f2ede3_55%,_#e8dfcf_100%)] px-6 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        >
          <p className="text-xs uppercase tracking-[0.18em] text-black/50">Vantage Receipt</p>
          <CheckCircle2 className="w-16 h-16 text-black mx-auto" />
          <h1 className="mt-5 text-4xl md:text-5xl font-light tracking-wide">Thank You</h1>
